...
# Generated by qmake (2.01a) (Qt 4.5.0) on: pt. wrz 18 04:25:54 2009
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/salvador1.0.0/ && $(COPY_FILE) --parents src/debug.h src/core/sabstractgrid.h src/core/sabstractmachine.h src/core/sabstractpointer.h src/core/scodegrid.h src/core/scodeimage.h src/core/scodeimagepointer.h src/core/scodemachine.h src/core/sdatagrid.h src/core/sdataimagepointer.h src/core/sdatamachine.h src/core/senums.h src/core/svirtualmachine.h .tmp/salvador1.0.0/ && $(COPY_FILE) --parents src/test.cpp src/core/sabstractgrid.cpp src/core/sabstractmachine.cpp src/core/sabstractpointer.cpp src/core/scodegrid.cpp src/core/scodeimage.cpp src/core/scodeimagepointer.cpp src/core/scodemachine.cpp src/core/sdatagrid.cpp src/core/sdataimagepointer.cpp src/core/sdatamachine.cpp src/core/svirtualmachine.cpp .tmp/salvador1.0.0/ && (cd `dirname .tmp/salvador1.0.0` && $(TAR) salvador1.0.0.tar salvador1.0.0 && $(COMPRESS) salvador1.0.0.tar) && $(MOVE) `dirname .tmp/salvador1.0.0`/salvador1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/salvador1.0.0
...
scodeimage.o: src/core/scodeimage.cpp src/core/scodeimage.h \
		src/core/senums.h \
		src/debug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o scodeimage.o src/core/scodeimage.cpp
